...
{\em argc} & Numero de argumentos ingresados en el terminal \\
\hline
{\em argv} & Argumentos ingresados en el terminal\\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
Esta funcion requiere de argumentos ingresados, por lo que es importante ejecutarla desde el terminal 
\end{DoxyNote}
